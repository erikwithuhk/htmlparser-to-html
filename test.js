...
var cases = {
  ...
  "self closing area tag ": "<area />",
  "self closing base tag ": "<base />",
  "self closing basefont tag ": "<basefont />",
  "self closing br tag ": "<br />",
  "self closing col tag ": "<col />",
  "self closing frame tag ": "<frame />",
  "self closing hr tag ": "<hr />",
  "self closing img tag ": "<img />",
  "self closing input tag ": "<input />",
  "self closing isindex tag ": "<isindex />",
  "self closing link tag ": "<link />",
  "self closing meta tag ": "<meta />",
  "self closing param tag ": "<param />",
  "self closing embed tag ": "<embed />",
  "self closing ?xml tag ": "<?xml />",
